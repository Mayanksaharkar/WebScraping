...
types = ['Monitors', 'Motherboard', 'Keyboard', 'Mouse', 'Graphics Card', 'Printers', 'Processors', 'Cabinets for PC', 'SSD','HDD', 'Pen Drives']
...
for type in types:
    ...
    for link in page_links:
        ...
        for link in prod_links:
            ...
            response = add_to_products(type= type, category="Computer Peripherals", brand=brand , title=title , rating=rating, price=price , desc_short=desc_short,  desc_long=desc_long, specification= spec_full, link=link , img_list=img_list ,cover_img=cover_img)
            print(response)
